    ...
    <div class="box-body">
        <div class="feed-item-head row mt-20 m-width-20">
            <div class="feed-item-head-photo">
                <a href="<?= $base; ?>/perfil/<?= $data->user->id; ?>"><img src="<?= $base; ?>/media/avatars/<?= $data->user->avatar ?? 'default.jpg'; ?>" /></a>
            </div>
        ...
        <div class="feed-item-comments">
            ...
            <div class="fic-answer row m-height-10 m-width-20">
                <div class="fic-item-photo">
                    <a href="<?= $base; ?>"><img src="<?= $base; ?>/media/avatars/<?= $loggedUser->avatar ?? 'default.jpg'; ?>" /></a>
                </div>
